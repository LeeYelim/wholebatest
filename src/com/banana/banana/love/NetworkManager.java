...
import com.loopj.android.http.TextHttpResponseHandler;
	...
	public class NetworkManager {
		...
		*/
		...
		public void addMission(Context context, String mission_theme, final OnResultListener<MissionResult> listener) {
			RequestParams params = new RequestParams();
		...
		public static final String DELETE_MISSION_URL = SERVER + "/missons/%s/delete";
		public void deleteMisson(Context context, int mlist_no, final OnResultListener<MissionResult> listener) {
			RequestParams params = new RequestParams();
			params.put("mlist_no", mlist_no); 
			String url = String.format(DELETE_MISSION_URL, mlist_no);
		...
		public void searchMissionInfo(Context context, int mlist_no, final OnResultListener<MissionInfoResponse> listener) {
			RequestParams param = new RequestParams();
			...
			client.get(context, url, param, new TextHttpResponseHandler() {
				...
				public void onSuccess(int statusCode, Header[] headers,
						String responseString) { 
					Gson gson = new Gson();
					MissionInfoResponse results = gson.fromJson(responseString, MissionInfoResponse.class);
					listener.onSuccess(results);
				}
		...
		/*--------아이템---------*/
		public static final String POSSIBLE_ITEM_LIST_URL= SERVER + "/items/buyinfo";
		...
		public static final String BUY_ITEM_URL = SERVER + "/items/%s/buy";
		public void buyItem(Context context, int item_no, final OnResultListener<BananaItemResponse> listener) {
			RequestParams params = new RequestParams();
			params.put("item_no", item_no); 
			String url = String.format(BUY_ITEM_URL, item_no);
		...
		public void useItem(Context context, int item_no, int mlist_no, final OnResultListener<BananaItemResponse> listener) {
			...
			params.put("item_no", item_no); 
			params.put("mlist_no", mlist_no);
			String url = String.format(BUY_ITEM_URL, item_no, mlist_no);
